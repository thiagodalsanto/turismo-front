...
export default function TourCard() {
    return (
        <div class="w-full max-w-sm max-h-96 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="/">
                <img class="rounded-t-lg object-cover h-48 w-96" src="https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="product" />
            </a>
            <div class="px-5 pb-5">
                <div class="pt-6">
                    <a href="/">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">El Nido, Philippines</h5>
                    </a>
                </div>
